# -*- coding: utf-8 -*-
"""
演習：製造ライン洗浄後の残留物を模した質量スペクトルを生成する

【想定する場面】
製造ライン洗浄後のQC用質量スペクトルを模擬的に作成し、CSVへ保存する。
各化合物のピークをガウス関数で足し合わせ、ノイズを加えて模擬測定データにする。
"""
...
# TODO: peak_tableの各行（compound, center_mz, height, width）について
#       ガウス関数でピークを作り、intensityへ加算してください
# ヒント： for row in peak_table.itertuples():
