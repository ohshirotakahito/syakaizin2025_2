...
【あなたの役割】
あなたは不動産会社のデータ分析担当者です。賃貸物件を、お手頃・中価格帯・
高級／広めの3つに分類して、お客様へのおすすめに利用します。

物件には家賃、広さ、駅からの徒歩時間、築年数があります。単位と数値の
大きさが異なる4項目を、そのまま機械学習へ渡してよいのでしょうか。
...
# 【考察問題1】
# 平均家賃だけで「高級物件」と判断してよいでしょうか。
# 追加するとよいデータを2つ以上挙げてください。
# 自分の答え：
